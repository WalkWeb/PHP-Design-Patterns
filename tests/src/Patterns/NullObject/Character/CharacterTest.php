...
namespace Tests\NullObject\Character;

use Patterns\NullObject\Character\Action\GoldAction;
use Patterns\NullObject\Character\Action\NullAction;
use Patterns\NullObject\Character\Action\TrapAction;
use Patterns\NullObject\Character\Character;
use Patterns\NullObject\Character\CharacterException;
use Patterns\NullObject\Episode\Episode;
